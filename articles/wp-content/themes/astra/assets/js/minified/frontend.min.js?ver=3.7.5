...
!(function () {
  ...
  window.addEventListener("resize", function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      var e, t;
      AstraToggleSetup(),
        (t = d.classList.contains("ast-header-break-point")
          ? ((e = document.getElementById("ast-mobile-site-navigation")),
            document.getElementById("ast-mobile-header"))
          : ((e = document.getElementById("ast-desktop-site-navigation")),
        ...
        (function (e, t) {
          if (e) {
            ...
            if (
              void 0 !== a ||
              void 0 !== (a = t.getElementsByTagName("a")[0])
            ) {
              var n = e.getElementsByTagName("ul")[0];
              if (void 0 !== n) {
